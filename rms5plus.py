...
def main():
    ...
    grafica_contorno(mag_Euclid, delta_DES, label_survey="DES", label_ref="Euclid", xlim=(15,27), ylim=(-0.5,0.5)) 
    grafica_contorno(mag_Euclid, delta_Rubin, label_survey="Rubin", label_ref="Euclid", xlim=(15,27), ylim=(-0.5,0.5)) 
    
    grafica_contorno_con_bins(mag_Euclid, delta_DES, label_survey="DES", label_ref="Euclid")
    grafica_contorno_con_bins(mag_Euclid, delta_Rubin, label_survey="Rubin", label_ref="Euclid")
    ...
    grafica_contorno(mag_Euclid_clean, delta_DES_clean, label_survey="DES", label_ref="Euclid", xlim=(15,27), ylim=(-0.5,0.5)) 
    grafica_contorno(mag_Euclid_clean, delta_Rubin_clean, label_survey="Rubin", label_ref="Euclid", xlim=(15,27), ylim=(-0.5,0.5)) 
    
    grafica_contorno_con_bins(mag_Euclid_clean, delta_DES_clean, label_survey="DES", label_ref="Euclid")
    grafica_contorno_con_bins(mag_Euclid_clean, delta_Rubin_clean, label_survey="Rubin", label_ref="Euclid")
