...
def main():
    ...
    n_boot = 200   # puedes subir a 500 si quieres más precisión
    mag_lim_samples = []

    for i in range(n_boot):
        sample = np.random.choice(mag_clean, size=len(mag_clean), replace=True)
    ...
    print("Magnitud límite (bootstrap):", mag_lim_mean)
    print("Incertidumbre (1σ):", mag_lim_std)
